...
public class HeaderPositionCalculator {
    ...
    private boolean isStickyHeaderBeingPushedOffscreen(RecyclerView recyclerView, View stickyHeader) {
        ...
        if(recyclerView instanceof CustomRecyclerView) {
            firstViewUnderHeaderPosition = firstViewUnderHeaderPosition - ((CustomRecyclerView) recyclerView).getHeaderSize();
        }
    ...
    private boolean itemIsObscuredByHeader(RecyclerView parent, View item, View header, int orientation) {
        ...
        if(parent instanceof CustomRecyclerView) {
            adapterPosition = adapterPosition - ((CustomRecyclerView) parent).getHeaderSize();
        }
