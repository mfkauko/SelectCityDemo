...
/**
 * Created by VailWei on 2016/3/24.
 * 支持下拉刷新和底部加载更多的RecyclerView
 * Based on XRecyclerView
 * 用法：setPullRefreshEnabled 是否支持下拉刷新 默认支持
 *      setLoadingMoreEnabled 是否支持加载更多 默认支持(modified：如果不支持加载更多，footview不会占据空间)
 *
 *      setRefreshProgressStyle(ProgressStyle.lineScale) 指定下拉刷新时候的header动画
 *      setLoadingMoreProgressStyle(ProgressStyle.BallRotate) 指定加载更多时footer的动画
 *      setArrowImageView 指定下拉时的箭头
 *      setLoadingListener
 */
public class CustomRecyclerView extends RecyclerView {
    ...
    private int mLoadingMoreProgressStyle = 0;
...
//    private ArrowRefreshHeader mRefreshHeader;
    private boolean pullRefreshEnabled = true;//是否支持下拉刷新
    private boolean loadingMoreEnabled = true;//是否支持加载更多
...
//            }
    ...
    private class WrapAdapter extends Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            if(isFooter(position) && !loadingMoreEnabled) {
                return;
            }
