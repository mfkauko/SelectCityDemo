...
import vail.demo.recyclerview.caching.HeaderProvider;
import vail.demo.recyclerview.caching.HeaderViewCache;
import vail.demo.recyclerview.calculation.DimensionCalculator;
import vail.demo.recyclerview.rendering.HeaderRenderer;
import vail.demo.recyclerview.util.LinearLayoutOrientationProvider;
import vail.demo.recyclerview.util.OrientationProvider;
...
public class StickyRecyclerHeadersDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if(parent instanceof CustomRecyclerView) {
            itemPosition = itemPosition - ((CustomRecyclerView) parent).getHeaderSize();
        }
    ...
    public void onDrawOver(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < parent.getChildCount(); i++) {
            ...
            if(parent instanceof CustomRecyclerView) {
                position = position - ((CustomRecyclerView) parent).getHeaderSize();
            }
